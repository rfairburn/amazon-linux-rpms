...
Requires: rpm-python27 
Requires: python27-ethtool >= 0.4
Requires: gnupg
Requires: sh-utils
%if 0%{?suse_version}
...
%endif
%if 0%{?fedora} || 0%{?rhel} > 5 || 0%{?suse_version} >= 1140 || 0%{?amzn}
Requires: python27-gudev
Requires: python27-hwdata
%else
...
%prep
%setup -q 
find . -name \*.py -exec sed -i 's@/usr/bin/python@/usr/bin/python27@g' {} +
...
%changelog
* Mon Apr 06 2015 Robert Fairburn <robert.fairburn@c2fo.com> 2.0.1-2
